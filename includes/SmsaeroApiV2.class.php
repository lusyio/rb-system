...
class SmsaeroApiV2
{
    ...
    private $email = 'mr-kelevras@yandex.ru'; //Ваш логин|email
    private $api_key = 'sPoFY1rcyAd6DbID44ZM4xstSUPX'; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
    private $sign = 'Rubezh'; //Подпись по умолчанию
